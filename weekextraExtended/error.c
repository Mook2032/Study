...
struct ErrorMessage errors[33] = {
  ...
  {ERR_STRING_TOO_LONG, "String is too long."},
  ...
  {ERR_TYPE_UNUSABLE, "The specified value type can\'t be used in this statement."},
  {ERR_OPERAND_UNUSABLE, "Specified value type can\'t use this operand."}
};
