...
//Dear me, you probably don't want to understand how the whole thing work.
//If that's the case, open teacher's pdf file, and code after the BNF instructions.
//Itadakimasho!
...
void compileParam(void) {
	if (lookAhead->tokenType == KW_VAR) eat(KW_VAR);
	eat(TK_IDENT);
	eat(SB_COLON);
	compileBasicType();
}
